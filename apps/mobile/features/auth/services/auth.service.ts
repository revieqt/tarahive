...
import { RegisterRequest, VerificationResponse } from '@/features/auth/types/auth.types';
...
export const registerUser = async (userData: RegisterRequest, device?: Partial<DeviceInfo>) => {
  try {
    const requestData = {
      ...userData,
