...
export default function Analytics() {
  ...
  const tabs = [
    { id: 0, label: 'Traction', path: '/analytics', content: null },
    { id: 1, label: 'Usage', path: '/analytics/usage', content: null },
    { id: 2, label: 'Travel Insights', path: '/analytics/travel', content: null },
    { id: 3, label: 'Revenue', path: '/analytics/revenue', content: null },
  ];
