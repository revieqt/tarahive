  ...
  return (
    <View style={[styles.chatHeader, { backgroundColor: primaryColor }]}>
      ...
      <View style={{ flex: 1 }}>
        ...
        {description && <ThemedText style={styles.chatHeaderDesc}>{description}</ThemedText>}
      </View>
      {optionsValue && (
        <OptionsPopup
          ...
          <View style={{flexDirection: 'row',alignItems: 'flex-end' }}>
            ...
            {onSend && (
                <TouchableOpacity onPress={onSend} style={styles.sendButton} disabled={value.trim() === ''}>
                    <ThemedIcons name="send" size={25} color={value.trim() === '' ? '#999' : accentColor} />
                </TouchableOpacity>
            )}
          </View>
    ...
    <View style={styles.bubbleOuter}>
      ...
      >
        ...
        >
          ...
          >
            {!isCurrentUser && name && (
              <ThemedText style={styles.bubbleName}>{name}</ThemedText>
            )}
